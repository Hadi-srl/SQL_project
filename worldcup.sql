...
--
-- Name: games a; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT a FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);


--
-- Name: games b; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT b FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
